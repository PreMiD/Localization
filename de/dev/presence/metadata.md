...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Sollte Objekt mit <code>name</code> und <code>id</code> des Mitwirkenden enthalten. Name ist Ihr Discord-Benutzername ohne den Bezeichner(#0000). Benutzer <code>id</code> kann aus Discord kopiert werden, indem der Entwicklermodus aktiviert und mit der rechten Maustaste auf Ihr Profil geklickt wird.</td>
