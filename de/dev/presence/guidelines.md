...
- Stelle sicher, dass die Änderungen nützlich sind. These may include fixes (code and typos), additions (descriptions and tags), etc. Do **not** change images if they are not outdated and are in specifications.
...
<div>
  <h2 style="font-size: 2rem; margin-bottom: 0;">Verifizierer</h2>
