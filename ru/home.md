...
# О PreMiD
- :mag: [Что такое PreMiD?](/about) Интенсивности за PreMiD почему вы должны использовать его.
...
- :bulb: [Предложить новую функцию](https://discord.gg/premid): Нам нужны ваши идеи!
