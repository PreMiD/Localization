...
When publishing Presences to the [Presences repository](https://github.com/PreMiD/Presences/), we require you to follow a set of guidelines. Joillekin nämä tiukat säännöt voivat vaikuttaa ankarilta. However, the implementation of these rulesets will keep us and the users from running into any issues.
...
![Tarkistukset](https://i.imgur.com/oqAakOc.png)
