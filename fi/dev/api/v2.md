...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left"><code>GET</code></td>
      <td style="text-align:left">Get Discord informations of our PreMiD Staff and Contributors / a specific user, using Discord User ID. Täytyy olla Discord-palvelimellamme.</td>
    </tr>
    <tr>
