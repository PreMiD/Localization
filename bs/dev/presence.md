...
5. Kreirajte datoteku u `metadata.json` unutar mape `dist`.
...
Napravili smo `metadata.json` kreator datoteka za lijene ljude [ovdje](https://eggsy.xyz/projects/premid/mdcreator). Još je predloženo da ovo pročitate kako biste znali kako to funkcionira.
