...
Morate osigurati `Object` s ključevima koji su ključ za niz, `keyValue` je vrijednost niza. A list of translated strings can be found at this endpoint: `https://api.premid.app/v2/langFile/presence/en/`
