...
PreMiD是一個簡單可自定義化的工具。 It supports many different platforms and will support multiple users watching the same content simultaneously in an upcoming update.
