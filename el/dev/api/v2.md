...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">Απόκτησε τους χρήστες που έχουν την προσβασή στο beta πρόγραμμά μας.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left"><code>GET</code></td>
      <td style="text-align:left">Απόκτησε πληροφορίες του Discord για το προσωπικό μας στο PreMiD και τους συνεισφέροντες / έναν σιγκεκριμμένο χρήστη, χρησιμοποιώντας την διεύθυνση ID του Discord χρήστη. Must be in our Discord server.</td>
    </tr>
    <tr>
