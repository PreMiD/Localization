...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Piccola descrizione della presence, è possibile utilizzare la descrizione del servizio se siete fuori idee. La tua descrizione deve avere valori di coppia chiave che indicano la lingua, e la descrizione in quella specifica lingua. Crea descrizioni con le lingue <i>che conosci</i>, i nostri traduttori modificheranno il file di metadati.</td>
      <td style="text-align:left"><code>Object</code></td>
      <td style="text-align:left"><code>No</code></td>
    </tr>
    <tr>
