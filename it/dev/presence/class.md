...
Devi procurare un `Object` con le chiavi a stringhe, `keyValue` è il valore della stringa. A compilation of translated strings can be found using this endpoint: `https://api.premid.app/v2/langFile/presence/en/`
