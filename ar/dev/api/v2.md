...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left"><code>GET</code></td>
      <td style="text-align:left">Get Discord informations of our PreMiD Staff and Contributors / a specific user, using Discord User ID. يجب أن تكون في سيرفر الديسكورد الخاص بنا.</td>
    </tr>
    <tr>
