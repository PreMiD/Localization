...
When publishing Presences to this GitHub, we require you to follow a set of guidelines. للبعض. قد تبدو هذه قواعد صارمة. However, the implementation of these rulesets will keep us and the users from running into any issues.
