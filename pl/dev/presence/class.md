...
Musisz podać `Obiekt` z kluczami dla ciągu znaków, `keyValue` jest wartością ciągu znaków. A compilation of translated strings can be found using this endpoint: `https://api.premid.app/v2/langFile/presence/en/`
