...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">Získajte užívateľov, ktorí sú môžu prijať náš beta program.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left"><code>GET</code></td>
      <td style="text-align:left">Získajte informácie o našich Presences / jeden Presence / súbor prítomnosti (Ex: presence.js, metadata.json).</td>
    </tr>
    <tr>
