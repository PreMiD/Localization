...
# Diretrizes
> Se você **NÃO** seguir as diretrizes, um `Verificador de Presença` vai solicitar as mudanças apropriadas, ou vai ter que fechar ela sobre algumas circunstâncias. 
> 
> {.is-warning}
