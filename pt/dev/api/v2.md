...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left"><code>GET</code></td>
      <td style="text-align:left">Obtenha o changelog da nossa Extensão.</td>
    </tr>
    <tr>
      <td style="text-align:left"><b>/v2/changelog/:projeto/:versão</b>
      </td>
      <td style="text-align:left"><code>GET</code></td>
      <td style="text-align:left">Obtenha o changelog de uma versão específica de nossa Extensão.</td>
    </tr>
  </tbody>
</table>
