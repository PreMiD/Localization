...
# Seja aprovado
Nosso objetivo principal é trabalhar com os usuários, então tente ser o mais amigável, respeitoso e informativo possível. Apenas ping um desenvolvedor no nosso [servidor do Discord](https://discord.gg/PreMiD) para obter essa revisão no GitHub ou não. Depende da qualidade do código, da aparência dos assets e de funcionalidade regular.